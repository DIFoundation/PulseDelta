...
import { TrendingUp, Zap, Trophy, Coins } from "lucide-react";
...
const marketTemplates: MarketTemplate[] = [
  {
    ...
    resolutionCriteria:
      "Market resolves based on official game/tournament results",
    examples: [
  ...
  },
  {
    ...
    resolutionCriteria:
      "Market resolves based on price data from major exchanges",
    examples: [
  ...
  },
  {
    ...
    outcomes: ["Yes", "No"],
    resolutionCriteria:
      "Market resolves based on social media metrics and verifiable data",
    examples: [
      "Will a TikTok video get 1M views in 24 hours?",
      "Will a Twitter post go viral this week?",
      "Will a YouTube video reach trending?",
    ],
  },
];
    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-muted-foreground">
          Select a template to get started quickly, or customize your own market
          structure
        </p>
      </div>
