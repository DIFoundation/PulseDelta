...
const steps = [
	{ id: 1, name: "Template", description: "Choose a market template" },
	{ id: 2, name: "Details", description: "Add market information" },
	{ id: 3, name: "Outcomes", description: "Configure outcomes" },
			...
			<motion.div
				...
				<div className="text-center mb-8">
					...
					<p className="text-muted-foreground max-w-2xl mx-auto">
						Launch your own prediction market with our guided wizard. Choose from
						templates or create custom markets.
					</p>
				</div>
