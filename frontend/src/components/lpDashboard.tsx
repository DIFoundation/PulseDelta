...
import { Droplets, TrendingUp, DollarSign, Calendar, Plus, ExternalLink } from "lucide-react"
...
export function LpDashboard() {
	...
	const historicalPositions = mockPositions.filter((p) => p.status === "withdrawn")
	...
	const totalFeesEarned = mockPositions.reduce((sum, p) => sum + p.feesTotal, 0)
	const avgApy =
			...
			<motion.div
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
					...
					<div className="glass-card p-6 text-center">
						...
						<div className="text-2xl font-bold mb-1">${totalFees24h.toFixed(2)}</div>
					...
					<div className="glass-card p-6 text-center">
						...
						<div className="text-2xl font-bold mb-1">${totalFeesEarned.toFixed(2)}</div>
										...
										<div className="flex items-start justify-between mb-4">
											<div className="flex-1">
												...
												<div className="flex items-center space-x-4 text-sm text-muted-foreground">
													<span>
														Added {formatDate(position.dateAdded)}
													</span>
													<Badge
														variant="outline"
