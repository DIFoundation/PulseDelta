...
export function MarketCard({
  ...
  console.log("MarketCard - Rendering market:", {
    id: market.id,
    title: market.title,
    curationStatus: market.curationStatus,
    state: market.state,
  });
  ...
  return (
    ...
    >
      <Link href={`/market/${market.id}`} className="flex-1 flex flex-col">
        {/* Header */}
        ...
        {/* Stats */}
        <div className="grid grid-cols-3 gap-4 text-center text-sm mt-auto">
          <div>
      ...
      {showQuickTrade && onQuickTrade && !market.resolved && (
        <motion.div
          className="pt-4 border-t border-glass-border mt-auto"
